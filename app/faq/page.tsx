            ...
            <div className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10 shadow-xl border border-sky-200 bg-sky-50">
              <div className="relative space-y-12">
                <header className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tight text-sky-600">Frequently Asked Questions</h1>
                ...
                <section className="space-y-3">
                  <h2 className="text-2xl font-semibold text-black">2. How long does a typical 3D animation take?</h2>
                  <p className="text-gray-700">
                ...
                <section className="space-y-3">
                  <h2 className="text-2xl font-semibold text-black">4. How do you price your services?</h2>
                  <p className="text-gray-700">
                    ...
                    <a href="/pricing" className="text-sky-600 underline hover:text-sky-700">
                      pricing page
                    </a>
                    .
                  </p>
                ...
                <section className="space-y-3">
                  <h2 className="text-2xl font-semibold text-black">5. Can we request changes after delivery?</h2>
                  <p className="text-gray-700">
                    Yes. All revisions are covered under our{" "}
                    <a href="/revisions" className="text-sky-600 underline hover:text-sky-700">
                      revision policy
                    </a>
                ...
                <section className="space-y-3">
                  <h2 className="text-2xl font-semibold text-black">7. What formats do you deliver in?</h2>
                  <p className="text-gray-700">
                ...
                <section className="space-y-3">
                  <h2 className="text-2xl font-semibold text-black">10. How do we get started?</h2>
                  <p className="text-gray-700">
                    Simply{" "}
