            ...
            <div className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10 shadow-xl border border-green-muted bg-green-muted">
              <div className="relative space-y-12">
                <header className="space-y-4">
                  <h1 className="text-[#064E3B] text-4xl font-bold tracking-tight text-green-dark">Frequently Asked Questions</h1>
                ...
                <section className="space-y-3">
                  <h2 className="text-[#064E3B] text-2xl font-semibold text-black">2. How long does a typical 3D animation take?</h2>
                  <p className="text-black">
                ...
                <section className="space-y-3">
                  <h2 className="text-[#064E3B] text-2xl font-semibold text-black">4. How do you price your services?</h2>
                  <p className="text-black">
                    ...
                    <a href="/pricing" className="text-green-dark underline hover:text-green-dark">
                      pricing page
                    </a>
                    .
                  </p>
                ...
                <section className="space-y-3">
                  <h2 className="text-[#064E3B] text-2xl font-semibold text-black">5. Can we request changes after delivery?</h2>
                  <p className="text-black">
                    Yes. All revisions are covered under our{" "}
                    <a href="/revisions" className="text-green-dark underline hover:text-green-dark">
                      revision policy
                    </a>
                ...
                <section className="space-y-3">
                  <h2 className="text-[#064E3B] text-2xl font-semibold text-black">7. What formats do you deliver in?</h2>
                  <p className="text-black">
                ...
                <section className="space-y-3">
                  <h2 className="text-[#064E3B] text-2xl font-semibold text-black">10. How do we get started?</h2>
                  <p className="text-black">
                    Simply{" "}
                    <a href="/contact" className="text-green-dark underline hover:text-green-dark">
                      contact us
                    </a>{" "}
